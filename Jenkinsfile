pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/mcclela'                                   //<-----change this to your MiamiID!
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/mcclela/225-lab4-2.git'     //<-----change this to match this new repository!
        KUBECONFIG = credentials('mcclela-225')                           //<-----change this to match your kubernetes credentials (MiamiID-225)! 
    }
